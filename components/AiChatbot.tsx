...
import { SendIcon, CloseIcon, TrashIcon, RetryIcon, ArrowsPointingInIcon, ArrowsPointingOutIcon, SparklesIcon, MicIcon, BookOpenIcon, DocumentTextIcon } from './icons';
