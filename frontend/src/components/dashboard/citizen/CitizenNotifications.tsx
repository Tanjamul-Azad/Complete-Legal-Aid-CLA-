...
import { BellIcon, BriefcaseIcon, VerificationIcon, CalendarIcon, SettingsIcon, WarningIcon, MessageIcon } from '../../ui/icons';
        ...
        <div className="animate-fade-in">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-md text-cla-text-muted dark:text-cla-text-muted-dark mt-1">Review and manage all your alerts.</p>
                </div>
