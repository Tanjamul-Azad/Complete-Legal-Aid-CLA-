...
import { VaultIcon, UploadIcon, TrashIcon, FileIcon, ImageIcon, PdfIcon, WordIcon, FolderLockIcon, LockClosedIcon, CheckCircleIcon, EyeIcon, DownloadIcon, CloseIcon, BriefcaseIcon } from '../../ui/icons';
...
export const CitizenVault: React.FC = () => {
    ...
    const handleUploadSubmit = (file: File, option: 'vault' | 'case', caseId?: string) => {
        ...
        if (targetCaseId) {
            simulateUpload(file, targetCaseId);
        } else {
    ...
    const simulateUpload = (file: File, caseId: string) => {
        ...
        setTimeout(() => {
            ...
            context.setToast({ message: "Document uploaded successfully", type: 'success' });
        }, 2000);
    };
