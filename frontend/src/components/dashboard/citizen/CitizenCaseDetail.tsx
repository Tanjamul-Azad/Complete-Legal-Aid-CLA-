...
import { SendIcon, StarIcon, UploadIcon, DocumentCloudIcon, BriefcaseIcon, VerifiedIcon, ChatBubbleLeftRightIcon, PaperClipIcon, LinkIcon, ScaleIcon, CalendarIcon, UserCircleIcon, DocumentTextIcon, SparklesIcon } from '../../ui/icons';
...
export const CitizenCaseDetail: React.FC<{
    ...
    const handleFileSelectAndSend = (file: File) => {
        if (file && selectedCase) {
            const newDoc = handleDocumentUpload(file, selectedCase.id);
            if (lawyer) {
                        ...
                        <div className="p-5">
                            {lawyer ? (
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h4 className="text-lg font-bold text-cla-text dark:text-white flex items-center gap-1">
                                        {lawyer.name}
