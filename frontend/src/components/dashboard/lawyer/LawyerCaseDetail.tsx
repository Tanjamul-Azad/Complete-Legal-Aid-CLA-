...
import { SendIcon, PaperClipIcon, ChevronLeftIcon, ClockIcon, BuildingOfficeIcon, ScaleIcon, DocumentTextIcon, CalendarIcon, UserCircleIcon, CloseIcon } from '../../ui/icons';
        ...
        <div className="animate-fade-in h-[calc(100vh-140px)] flex flex-col">
            ...
            <div className="flex items-center justify-between mb-4 flex-shrink-0">
                ...
                <div className="flex gap-2">
                    <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide ${selectedCase.status === 'In Review' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' :
                        ...
                        {caseMessages.map((msg) => {
                            ...
                            return (
                                <div key={msg.id} className={`flex items-end gap-3 ${isMe ? 'justify-end' : 'justify-start'}`}>
                                    ...
                                    <div className={`max-w-[75%] rounded-2xl px-4 py-2.5 shadow-sm text-sm leading-relaxed ${isMe
