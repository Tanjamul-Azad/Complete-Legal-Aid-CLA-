...
import { MessageIcon, ClockIcon, SearchIcon, BriefcaseIcon } from '../../ui/icons';

export const LawyerMessages: React.FC = () => {
    ...
    const handleChatClick = (convo: any) => {
        ...
        if (convo.latestMessage.caseId) {
            ...
            // If no case attached, maybe go to clients or generic chat view (fallback to cases for now)
            setDashboardSubPage('cases');
        }
    };
    ...
    return (
        <div className="animate-fade-in max-w-5xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-cla-text dark:text-white">Client Messages</h1>
                    <p className="text-sm text-cla-text-muted dark:text-cla-text-muted-dark mt-1">
                        Manage communications across all your active cases.
                    </p>
                </div>
            ...
            <div className="bg-white dark:bg-cla-surface-dark rounded-xl border border-cla-border dark:border-cla-border-dark shadow-sm overflow-hidden">
                {conversations.length > 0 ? (
                    ...
                    <div className="text-center py-24">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Conversations with your clients will appear here.</p>
                    </div>
                )}
            </div>
        </div>
