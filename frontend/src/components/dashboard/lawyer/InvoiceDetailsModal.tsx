...
import { CloseIcon, DocumentTextIcon } from '../../ui/icons';
                ...
                <div className="px-5 py-4 space-y-4 text-xs">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <span className={`inline-flex mt-0.5 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide ${invoice.status === 'paid' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' :
