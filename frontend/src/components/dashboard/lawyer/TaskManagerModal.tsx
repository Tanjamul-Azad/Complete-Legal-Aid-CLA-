...
import { CloseIcon, PlusCircleIcon, CalendarIcon, CheckIcon, TrashIcon, ClipboardDocumentCheckIcon, ClockIcon } from '../../ui/icons';
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-cla-bg dark:bg-cla-bg-dark custom-scrollbar">
                    <div className="space-y-3">
                        {filteredTasks.length > 0 ? filteredTasks.map(task => (
                            <div
                                key={task.id}
                                className={`group flex items-center justify-between p-4 rounded-xl border transition-all duration-200 hover:shadow-md ${task.completed
