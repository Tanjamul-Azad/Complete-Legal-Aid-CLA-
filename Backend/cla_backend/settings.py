...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'complete_legal_aid'),
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # Removed strict validators for easier password requirements
]
...
AUTHENTICATION_BACKENDS = [
    'api.backends.EmailBackend',  # Custom email authentication
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",
    "http://192.168.0.101:3000",  # Network IP for local network access
